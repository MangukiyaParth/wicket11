...
if (IS_PRODUCTION) {
    ...
    define("API_SERVICE_URL", "http://" . $_SERVER['HTTP_HOST'] . "/wicket11/api_services/");
    define("ADMIN_PANEL_URL", "http://" . $_SERVER['HTTP_HOST'] . "/wicket11/");
    define("ROOT_URL", "http://" . $_SERVER['HTTP_HOST'] . "/wicket11/");
