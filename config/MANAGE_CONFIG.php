...
if (IS_PRODUCTION) {
    ...
    define("ADMIN_PANEL_URL", "https://" . $_SERVER['HTTP_HOST'] . "/");
    define("ROOT_URL", "https://" . $_SERVER['HTTP_HOST'] . "/");
    define("ALLOW_EXTERNAL_SCRIPT", "1");
    define("ALLOW_MIXPANEL_SCRIPT", "1");
} else {
    define("API_SERVICE_URL", "http://" . $_SERVER['HTTP_HOST'] . "/panels/wicket11/api_services/");
    define("ADMIN_PANEL_URL", "http://" . $_SERVER['HTTP_HOST'] . "/panels/wicket11/");
    define("ROOT_URL", "http://" . $_SERVER['HTTP_HOST'] . "/panels/wicket11/");
