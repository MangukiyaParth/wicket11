    ...
    function initLeftSidebar() {
        ...
        if ($(".side-nav").length) {
            ...
            $(".side-nav a").each(function () {
                ...
                var current_page_split_url = pageUrl.split(/[/#]/);
                var currentPage = current_page_split_url[current_page_split_url.length - 1];
    ...
    function initShowHidePassword() {
        $("[data-password]").on('click', function () {
            if ($(this).attr('data-password') == "false") {
                ...
                $(this).find('svg')[0].setAttributeNS(null, "class", "svg-inline--fa fa-eye-slash" ); // add this line;
            } else {
                $(this).siblings("input").attr("type", "password");
                $(this).attr('data-password', 'false');
                $(this).removeClass("show-password");
                $(this).find('svg')[0].setAttributeNS(null, "class", "svg-inline--fa fa-eye" );
            }
        });
    }
...
class ThemeCustomizer {
    ...
    initSwitchListener() {
        ...
        var menuToggleBtn = document.querySelector('.button-toggle-menu-desktop');
        if (menuToggleBtn) {
        ...
        var menuToggleBtn = document.querySelector('.button-toggle-menu-mobile');
        if (menuToggleBtn) {
            menuToggleBtn.addEventListener('click', function () {
                var configSize = self.config.sidenav.size;
                var size = self.html.getAttribute('data-sidenav-size', configSize);
